#############################################################################
# Makefile for building: SQLTest
# Generated by qmake (3.1) (Qt 5.9.0)
# Project:  SQLTest.pro
# Template: app
# Command: /home/wlw/Qt5.9.0/5.9/gcc_64/bin/qmake -o Makefile SQLTest.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = SQLTest1.0.0
DISTDIR = /home/wlw/SQLTest/.tmp/SQLTest1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS) -L/usr/lib/x86_64-linux-gnu -lmysqlclient -lpthread -lz -lm -lrt -latomic -ldl 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
Makefile: SQLTest.pro ../Qt5.9.0/5.9/gcc_64/mkspecs/linux-g++/qmake.conf ../Qt5.9.0/5.9/gcc_64/mkspecs/features/spec_pre.prf \
		../Qt5.9.0/5.9/gcc_64/mkspecs/common/unix.conf \
		../Qt5.9.0/5.9/gcc_64/mkspecs/common/linux.conf \
		../Qt5.9.0/5.9/gcc_64/mkspecs/common/sanitize.conf \
		../Qt5.9.0/5.9/gcc_64/mkspecs/common/gcc-base.conf \
